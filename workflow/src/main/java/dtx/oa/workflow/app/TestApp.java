...
import dtx.oa.workflow.entity.impl.DTXUserEntityManager;
import dtx.oa.workflow.util.EntityUtil;
import dtx.oa.workflow.util.ReflectionUtil;
...
//            System.out.println("--------------->>>"+user.getFirstName());
        for(User user:identityService.createUserQuery().memberOfGroup("ff808081598818400159881a89a90004").listPage(0, 10))
            System.out.println("--------------->>>"+user.getFirstName());
